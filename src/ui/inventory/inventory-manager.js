...
import { InventoryItems, ITEM_CATEGORIES } from './inventory-items.js';
...
class InventoryManager {
    ...
    filterByCategory(items) {
        if (this.currentCategory === ITEM_CATEGORIES.ALL) {
            return items;
        }
        
        const allowedTypes = InventoryItems.getCategoryItems(this.currentCategory);
    ...
    moveItem(fromIndex, toIndex) {
        ...
        if (this.onItemMoveCallback) {
            this.onItemMoveCallback(fromIndex, toIndex);
        }
    }
    ...
    static createWithInventory(inventoryData) {
        const manager = new InventoryManager();
        manager.open(inventoryData);
        return manager;
    }
}
